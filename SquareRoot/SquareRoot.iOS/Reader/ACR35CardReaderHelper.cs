...
namespace SquareRoot.iOS.Reader
{
    public class Acr35CardReaderHelper : NSObject, ICardReaderHelper, IACRAudioJackReaderDelegate
    {
		...
		public void ReaderDidAuthenticate(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader,
		...
		public void ReaderDidNotifyResult(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader,
			ACR3x.sdk.iOSBindings.ACRResult result)
        {
		...
		public void ReaderDidNotifyTrackData(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader)
        {
            Debug.WriteLine("ReaderDidNotifyTrackData");
        }

        [Foundation.Export("readerDidReset:")]
		public void ReaderDidReset(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader)
        {
            Debug.WriteLine("ReaderDidReset");
        }

        [Foundation.Export("reader:didSendCustomId:length:")]
        public void ReaderDidSendCustomId(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader,
        ...
        public void ReaderDidSendDeviceId(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader,
            System.IntPtr deviceId, System.nuint length)
        {
            Debug.WriteLine("ReaderDidSendDeviceId");
        }

        public void ReaderDidSendDukptOption(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader, bool enabled)
        {
            Debug.WriteLine("ReaderDidSendDupktOption");
        }

        [Foundation.Export("reader:didSendFirmwareVersion:")]
        public void ReaderDidSendFirmwareVersion(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader,
        ...
        public void ReaderDidSendPiccAttr(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader, System.IntPtr attr,
            System.nuint length)
        {
        ...
        public void ReaderDidSendPiccResponseApdu(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader,
        ...
        public void ReaderDidSendRawData(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader,
        ...
        public void ReaderDidSendStatus(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader,
            ACR3x.sdk.iOSBindings.ACRStatus status)
        {
        ...
        public void ReaderDidSendTrackData(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader,
            ACR3x.sdk.iOSBindings.ACRTrackData trackData)
        {
...
//                                StripeService.GetCreditCardProvider(track1Data.PrimaryAccountNumber);
        ...
        public void ReaderDidSendTrackDataOption(ACR3x.sdk.iOSBindings.ACRAudioJackReader reader,
            ACR3x.sdk.iOSBindings.ACRTrackDataOption option)
        {
